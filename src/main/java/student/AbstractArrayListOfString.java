...
public abstract class AbstractArrayListOfString {
     ...
     */
    public AbstractArrayListOfString() {
     ...
     */
    public AbstractArrayListOfString(int initialCapacity) {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AbstractArrayListOfString otherList)) {
            return false;
        }
     ...
     */
    public abstract int countLetteryStrings();
}
